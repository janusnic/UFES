...
module.exports = function (grunt) {
   ...
   grunt.initConfig({
      ...
      // Enforce the whole team to use the same code style
      jscs: {
         src: '<%= config.app %>/scripts/**/*.js',
         options: {
            config: '.jscsrc',
            // Comment the following line for debugging purposes only
            force: false,
            fix: true
         }
      },
      ...
      // Create sprites from set of images
      sprite: {
         all: {
